...
class EfficientPS(BaseDetector):
    ...
    def simple_test(self, img, img_metas, proposals=None, rescale=False, eval=None):
        ...
        sem_pred = torch.argmax(semantic_logits, dim=1)[0] #semantic prediction
        result=sem_pred.cpu().detach().numpy()

        results = [[result,img_metas]]
    ...
    #               det_labels,
    #               semantic_logits, 
    #               rescale=False):  #panoptic fusion module
    ...
    #                                mode="bilinear", align_corners=False)   
    #     sem_pred = torch.argmax(semantic_logits, dim=1)[0] #semantic prediction
    #     print("Semantic Prediction")
    #     print(sem_pred)
    #     sempred1=sem_pred.cpu().detach().numpy()
    #     print(sempred1)
    #     plt.imshow(sempred1)
    ...
    #     #my edit
    #     # cat_=torch.Tensor(cat)
    #     return panoptic_mask.cpu(), cat_.cpu() #cat_ to cat"
