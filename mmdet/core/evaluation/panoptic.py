...
def save_panoptic_eval(results):
    ...
    #     print(panPredIds)
    #     # panPredIDs is unique class Id's in pan_pred
    #     segmInfo = []   

    #     # Modified

    #     for panPredId in panPredIds:
    #         print(pan_pred[panPredId])
    #         if pan_pred[panPredId] == 255:
    #             continue
    #         elif pan_pred[panPredId] <= 10:
    #             semanticId = segmentId = originalIds[pan_pred[panPredId]] 
    #         else:
    #             semanticId = originalIds[pan_pred[panPredId]]
