...
from labels import labels as cs_labels
from pycococreatortools import pycococreatortools as pct

parser = argparse.ArgumentParser(description="Convert Freiburg to coco format")
...
_INSTANCE_EXT = ".png"
_IMAGE_EXT = ".jpg"
_EVAL = "freiburg_panoptic_val"

def main(args):
    print("Loading Freiburg from", args.root_dir)
    global _EVAL
